...
namespace DreamNetwork.PlatformServer.IO
{
        ...
        ICollection
    {
        ...
        /// <see cref="T:DreamNetwork.PlatformServer.IO.ReadOnlyDictionary`2"></see>.
        /// </summary>
        /// <value>The number of key/value pairs.</value>
        /// <returns>The number of key/value pairs contained in the
        /// <see cref="T:DreamNetwork.PlatformServer.IO.ReadOnlyDictionary`2"></see>.</returns>
        public int Count
        {
        ...
        /// <see cref="T:DreamNetwork.PlatformServer.IO.ReadOnlyDictionary`2"/>.
        /// </summary>
        ...
        /// <see cref="T:DreamNetwork.PlatformServer.IO.ReadOnlyDictionary`2"/>.</summary>
        /// <param name="key">
        ...
        /// <summary>Determines whether the <see cref="T:DreamNetwork.PlatformServer.IO.ReadOnlyDictionary`2" />
        /// contains the specified key.</summary>
        /// <returns>
        /// True if the <see cref="T:DreamNetwork.PlatformServer.IO.ReadOnlyDictionary`2" /> contains
        /// an element with the specified key; otherwise, false.
        /// </returns>
        /// <param name="key">The key to locate in the
        /// <see cref="T:DreamNetwork.PlatformServer.IO.ReadOnlyDictionary`2"></see>.</param>
        /// <exception cref="T:System.ArgumentNullException">
        /// Thrown when the key is null.
        /// </exception>
        ...
        /// <summary>
        /// This method is not supported by the <see cref="T:DreamNetwork.PlatformServer.IO.ReadOnlyDictionary`2"/>.
        /// </summary>
        ...
        /// <returns>
        /// <b>true</b> if the <see cref="T:DreamNetwork.PlatformServer.IO.ReadOnlyDictionary`2" /> contains
